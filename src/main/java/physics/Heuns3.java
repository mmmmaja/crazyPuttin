...
public class Heuns3 extends Solver{
	...
	public Vector2D[] calculateNext(Vector2D position , Vector2D velocity , double H) {
		...
		double x = position.getX() + H*average(c , new double[]{ velocity.getX() ,k2V.getX() , k3V.getX() } , denominator) ;
		double y = position.getY() + H*average(c , new double[]{ velocity.getY() ,k2V.getY() , k3V.getY() } , denominator) ;
		double vX = velocity.getX() + H*average(c , new double[]{ k1a.getX() ,k2a.getX() , k3a.getX() } , denominator) ;
		double vY = velocity.getY() + H*average(c , new double[]{ k1a.getY() ,k2a.getY() , k3a.getY() } , denominator) ;
