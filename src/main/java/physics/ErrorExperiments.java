...
public class ErrorExperiments {
    ...
    static int[] iterationsRunTime = { 4,10,101, 201, 301, 401, 501, 601, 701, 801, 901, 1001, 1101, 1201, 1301, 1401, 1501, 1601, 1701, 1801, 1901, 2001};
    static double[] stepsRunTime = {
               0.25,0.1,  0.009900990099010, 0.004975124378109, 0.003322259136213, 0.002493765586035, 0.001996007984032, 0.001663893510815
            , 0.001426533523538, 0.001248439450687, 0.001109877913430, 0.000999000999001, 0.000908265213442, 0.000832639467111, 0.000768639508071
            , 0.000713775874375, 0.000666222518321, 0.000624609618988, 0.000587889476778, 0.000555247084953, 0.000526038926881, 0.000499750124938
    };
    static int[] iterationsError = { 4    , 5   , 10  , 20   , 25   , 50  , 100  , 200   , 250   , 500   , 1000  , 2000   };
    static double[] stepsErrors =  { 0.25 , 0.2 , 0.1 , 0.05 , 0.04 , 0.02, 0.01 , 0.005 , 0.004 , 0.002 , 0.001 , 0.0005 };
    public static void main(String[] args) {
        ...
        for (int i = 0; i < solvers.length; i++) {
            solver = solvers[i];
            ArrayList<ArrayList<Double>> experiments = runTimeExp(solvers[i]);
...
//            System.out.println(iterationsError[i] + " " + stepsErrors[i]);
